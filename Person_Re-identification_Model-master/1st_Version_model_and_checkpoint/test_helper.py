...
def make_single_dataset(image_size=[256, 128], tfrecords_path="dataset_dir/test/mars_test_validation_00000-of-00001.tfrecord", shuffle_buffer_size=2000, repeat=True, train=True):
    """
	Input:
