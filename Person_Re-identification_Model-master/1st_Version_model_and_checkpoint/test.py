...
image_one_path = args.img1
image_two_path = args.img2
...
if __name__ == '__main__':
    ...
    img = Image.open(image_one_path)
    img = np.array(img)[np.newaxis, :, :, :]

    img2 = Image.open(image_one_path)
    ...
    with tf.Session() as sess:
        ...
        my_logits, model_lf, model_rg = sess.run([logits, model_left, model_right], feed_dict={left_input_im: img, right_input_im: img2})
