...
from dataset_utils import _dataset_exists, _get_filenames_and_classes, _convert_dataset, write_label_file,  write_data_summary
...
flags.DEFINE_string('dataset_dir',  "dataset_dir/train/", 'String: Train dataset directory')
