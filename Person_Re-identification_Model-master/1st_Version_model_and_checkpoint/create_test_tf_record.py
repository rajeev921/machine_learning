...
import random
import tensorflow as tfa# USAGE: python3 create_tf_record.py --tfrecord_filename=mars --dataset_dir=./mars/
...
flags.DEFINE_string('dataset_dir', "dataset_dir/test/", 'String: Test dataset directory')
